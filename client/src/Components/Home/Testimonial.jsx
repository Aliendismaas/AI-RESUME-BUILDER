...
const Testimonial = () => {
  ...
  return (
    <>
    <div id='testmonials' className='flex flex-col my-10 items-center scroll-mt-2'>
      <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-4 py-1.5">
            <BookUserIcon width={14} className='size-4.5 stroke-green-500'/>
            <span>Testsimonials</span>
        </div>
        <Title title="Don't just take our words" description="Hear What our users say about us. We're always looking for ways to improve. If you have a positive experience with us, leavea review "/>
    </div>
     <style>{`
