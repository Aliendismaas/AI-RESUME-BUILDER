...
//                             Login
//                         </Link>
//                         <Link to='/app' className="hidden md:block px-6 py-2 border bg-green-500 active:scale-95 hover:bg-green-700 transition-all rounded-full text-white " hidden={!user}>
//                             Dashboard
//                         </Link>
//                     </div>
...
//                     <p className="max-w-md text-center text-base my-7">Create, Edit and download proffessional resume with AI-powered assistance.</p>
  ...
  return (
    <>
            <div className="min-h-screen pb-20">
                ...
                {/* Mobile Menu - ONLY THIS PART IS MODIFIED */}
                <div className={`fixed inset-0 z-100 bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                    <a href="/" className="text-white">Home</a>
                    ...
                    {!user ? (
                        <>
                            <Link 
                                ...
                                className="px-8 py-3 border border-white/30 active:scale-95 hover:bg-white/10 transition-all rounded-full text-white backdrop-blur"
                            >
                                Login
                            </Link>
                            <Link 
