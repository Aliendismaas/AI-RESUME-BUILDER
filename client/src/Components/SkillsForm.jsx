  ...
  return (
    <div className='space-y-4'>
...

      {
        data.length > 0 ?(
            ...
            <div className='text-center py-6 text-gray-500'>
                <Sparkles className='w-10 h-10 mx-auto mb02 text-gray-300'/>
      ...
      <div className='bg-blue-50 p-3 rounded-lg'>
        ...
        <strong>Tip: </strong>Add 8-12 relevant skills. Include Both Technical(Programming langauges, tools) and Soft Skills(TeamWork, Leadership..)
        </p>
